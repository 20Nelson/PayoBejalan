        ...
        btnUbah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nama.trim().equals("")){
                    ...
                    if (eks == -1){
                        Toast.makeText(ChangeActivity.this, "Ubah Data Gagal", Toast.LENGTH_SHORT).show();
                    }else{
                        Toast.makeText(ChangeActivity.this, "Ubah Data Berhasil", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }
            }
